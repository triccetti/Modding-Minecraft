...
public class EntityGoat extends EntityAnimal {
	public static final ResourceLocation GOAT_TEXTURE = new ResourceLocation(Refrence.MOD_ID + ":textures/entities/goat.png");
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(3, new EntityAITempt(this, 1.25D, ModItems.arugula, false));
	...
	public boolean isBreedingItem(ItemStack stack) {
		return stack == null ? false : stack.getItem() == ModItems.arugula;
	}
