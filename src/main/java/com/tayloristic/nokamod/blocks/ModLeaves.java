...
import com.tayloristic.nokamod.Refrence.NokaModLeaves;
...
public class ModLeaves extends Block implements net.minecraftforge.common.IShearable {
	...
	public ModLeaves(NokaModLeaves block, Block log) {
